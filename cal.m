...
ICs = load("./mat/yoz/ICs.mat", 'ICs').ICs;
obj = load("./mat/yoz/obj.mat", 'obj').obj;

points = 400;
x0 = linspace(0,0.4,points);
...
figure; hold on;
plot(x0, B, 'b-', 'Color', [0 0 1]); % 蓝色线表示 Bxc
grid on;
...
% y_vals = 0.12 * ones(1,num_points_y);
% 
