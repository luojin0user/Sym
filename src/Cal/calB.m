...
ICs_xoz = load("./mat/ICs.mat").ICs_xoz;
ICs_yoz = load("./mat/ICs.mat").ICs_yoz;

obj = load("./mat/all_regions.mat", 'obj').obj;
coil = load("./mat/RCoil.mat", 'obj').obj;

factor_x = coil.fx;
factor_y = coil.fy;

[Bx, Bz_xoz] = obj.cal_Bx_By("xoz", ICs_xoz,  x0', z0');
[By, Bz_yoz] = obj.cal_Bx_By("yoz", ICs_yoz, y0', z0');
